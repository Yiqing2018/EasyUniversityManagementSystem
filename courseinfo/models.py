...
class Section(models.Model):
    ...
    # if you delete an object, make sure it's not a foreign key to other tuples
    ...
    def __str__(self):
        return '%s - %s (%s)' % (self.course.course_number,self.section_name,
                                 self.semester.__str__())
...
class Registration(models.Model):
    ...
    student=models.ForeignKey(Student,related_name='registration',
                              on_delete=models.PROTECT)
    section=models.ForeignKey(Section,related_name='registration',
                              on_delete=models.PROTECT)
